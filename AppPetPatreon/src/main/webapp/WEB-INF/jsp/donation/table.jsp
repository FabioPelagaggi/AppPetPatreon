    ...
    <body>
      ...
      <div class="d-flex justify-content-center">
        <div class="shadow p-3 mb-5 bg-white container card card-block w-auto m-5">
          ...
          <c:if test="${not empty addedDonation}">
            <div class="alert alert-success">
              <strong>Success!</strong> New Donation ${addedDonation.name} was registred.
            </div>
          </c:if>

          <c:if test="${not empty removedDonation}">
            <div class="alert alert-success">
              <strong>Success!</strong> Donation ${removedDonation.name} was removed.
            </div>
          </c:if>
